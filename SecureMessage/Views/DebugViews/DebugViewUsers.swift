                ...
                List {
                    ForEach(users) { user in
                        VStack(alignment: .leading) {
                            Text("\(user.profile_name)").font(.title3).bold()
                            ...
                            Button {
                                ...
                                users.append(User(id: nil, uid: user.uid, profile_name: user.profile_name, bio: "", email: user.email, suspended: false, business: false, verified: false))
