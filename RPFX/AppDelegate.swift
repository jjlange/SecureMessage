...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        let window = NSWindow(contentRect: NSRect(x: 0, y: 0, width: 480, height: 300),
                ...
                let headingLabel = NSTextField(labelWithString: "Xcode for Discord")
                headingLabel.translatesAutoresizingMaskIntoConstraints = false
                headingLabel.font = NSFont.boldSystemFont(ofSize: 24)
                ...
                let refreshButton = NSButton(title: "Force Refresh Status", target: self,
                ...
                NSLayoutConstraint.activate([
                    refreshButton.centerXAnchor.constraint(equalTo:
                        contentView.centerXAnchor),
                    refreshButton.topAnchor.constraint(equalTo:
                        headingLabel.bottomAnchor, constant: 20),
                    ])
                
                let quitButton = NSButton(title:"Quit", target:NSApp,
                ...
                contentView.addSubview(quitButton)
                 ...
                 NSLayoutConstraint.activate([
                     quitButton.centerXAnchor.constraint(equalTo:
                         contentView.centerXAnchor),
                     quitButton.topAnchor.constraint(equalTo:
                         refreshButton.bottomAnchor, constant :20),
                 ])
